...
class RadonEye : public PollingComponent, public Sensor {
    ...
    public:
        ...
        // constructor
        RadonEye(String arg_address) : PollingComponent(60000) {
            My_BLE_Address = arg_address;
        }
        ...
        void setup() override {
            ...
            BLEAddress bleadr = BLEAddress(My_BLE_Address.c_str());
        ...
        void update() override {
            ...
            if(pClient->isConnected())
            {
                ...
                if(pRemoteCharacteristic->canRead()) {
                    ...
                    puls10 = pulsval.b;
                    ESP_LOGD("custom","Radonnow %.2f Day %.2f Month %.2f Pulse %i Puls10min %i ", radonnow, radonday, radonmonth, puls, puls10);
                }
                radon_10min->publish_state(radonnow);
